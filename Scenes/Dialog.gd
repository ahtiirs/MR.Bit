...
var dialog = {
	...
	"CPU":"Äkki see, mida sa vajad, on aju?",
	"RAM":"Leia midagi, millele saab märkmeid teha!",
	"HDD":"Vanasti oli kogu tarkus talletatud pikaks ajaks raamatutesse. Ehk leiad raamatuid!",
	"PSU":"Telefonid saavad energiat akudest, äkki saab arvuti ka!",
	"Keyboard":"Leia midagi, millel saab klahvidel lõbusalt klõbistada!",
	...
	"Soundcard":"Vanaisal oli see asi, mida sa otsid. Ta kuulas sellega oma lemmiklugusid.",
